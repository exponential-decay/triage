...
var tika_path_meta_recursive string = "http://127.0.0.1:9998/rmeta/form/text"		//xml/text/html
var siegfried_id = "http://127.0.0.1:2040/identify/?format=yaml" //csv,yaml,json
